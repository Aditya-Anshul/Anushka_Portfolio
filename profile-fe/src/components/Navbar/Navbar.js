  ...
  return (
    <div className="navbar">
      <div className="navbar--container">
        <h1 style={{ color: theme.secondary }}>Anushka Srivastava</h1>
      ...
      >
        ...
        <div onClick={handleDrawerClose}>
          <div className="navLink--container">
            ...
            <Fade left>
              <a
                href="https://1drv.ms/p/s!AndE1Aw-LPOogQoGq4ozjpISK2Hz?e=D6aebn"
                target="_blank"
                rel="noreferrer"
              >
                <div className={classes.drawerItem}>
                  <MdPhone className={classes.drawerIcon} />
                  <span className={classes.drawerLinks}>MyResources</span>
                </div>
              </a>
            </Fade>
